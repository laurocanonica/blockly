...
function getEntities() {
	var entList= [ 
		    ...
		    [ Blockly.Msg.e_zombie_pigman, 'e.zombie_pigman' ],
...
function getMaterials() {
	var obList= [  
	    ...
	    [ Blockly.Msg.b_flowing_water, 'b.flowing_water' ],
	    [ Blockly.Msg.b_four_turtle_eggs, 'b.four_turtle_eggs' ],
	    ...
	    [ Blockly.Msg.b_three_turtle_eggs, 'b.three_turtle_eggs' ],
	    ...
	    [ Blockly.Msg.b_two_turtle_eggs, 'b.two_turtle_eggs' ],
	    [ Blockly.Msg.b_vine, 'b.vine' ],
	    [ Blockly.Msg.b_void_air, 'b.void_air' ],
	    [ Blockly.Msg.b_wall_banner, 'b.wall_banner' ],
...
function getMaterials_opOnly() {
	return [		
	    ...
	    [ Blockly.Msg.b_flowing_lava, 'b.flowing_lava' ],
...
function getItems() {
	return [				
	    ...
	    [ Blockly.Msg.i_creeper_head, 'i.creeper_head' ],
	    ...
	    [ Blockly.Msg.i_dragon_head, 'i.dragon_head' ],
	    ...
	    [ Blockly.Msg.i_skeleton_skull, 'i.skeleton_skull' ],
	    ...
	    [ Blockly.Msg.i_wither_skeleton_skull, 'i.wither_skeleton_skull' ],
	    ...
	    [ Blockly.Msg.i_zombie_head, 'i.zombie_head' ],
	    [ Blockly.Msg.i_zombie_horse_spawn_egg, 'i.zombie_horse_spawn_egg' ],
	    [ Blockly.Msg.i_zombie_pigman_spawn_egg, 'i.zombie_pigman_spawn_egg' ],
						  ...
						  "args0": [
						    {
						      "type": "input_value",
						      "name": "NAME",
						      "check": ["Material", "Item", "Multiciplity"]
						    }
						  ],
						  "inputsInline": true,
						  "previousStatement": null,
